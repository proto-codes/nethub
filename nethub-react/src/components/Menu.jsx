          ...
          <div className="row gap-1 m-0 mb-1">
            <ul className="nav col border rounded">
              <li title='Profile' className='nav-item'>
                <Link to="/profile" className='nav-link d-flex gap-2 align-items-center p-0 px-1 text-body'>
          ...
          <div className="row gap-1 m-0 mb-1">
            <ul className="nav col border rounded">
              <li title="Shop" className='nav-item'>
                  <Link to='/shop' className='nav-link d-flex gap-2 align-items-center p-0 px-1 text-body'>
            ...
            <ul className="nav col border rounded">
              <li title="Videos" className='nav-item'>
                  <Link to='/videos' className='nav-link d-flex gap-2 align-items-center p-0 px-1 text-body'>
          ...
          <div className="row gap-1 m-0 mb-1">
            <ul className="nav col border rounded">
                <li title="Friends" className='nav-item'>
                  <Link to='/friends' className='nav-link d-flex gap-2 align-items-center p-0 px-1 text-body'>
            ...
            <ul className="nav col border rounded">
                <li title="Messages" className='nav-item'>
                    <Link to='/messages' className='nav-link d-flex gap-2 align-items-center p-0 px-1 text-body'>
