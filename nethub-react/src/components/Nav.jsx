    ...
    <div>
        <nav className={'bg-body z-3 p-2 border-end ' + props.hideNav}>  
            <div className='nav-box h-100 position-relative d-flex flex-column justify-content-center'>
                <a href='/' title="Logo" className='position-absolute top-0 d-flex gap-2 text-body text-decoration-none'>
                ...
                <ul className="nav nav-pills flex-column my-5">
                    <li title='Home' className='nav-item'>
                        <Link to="/" className={'nav-link d-flex gap-2 align-items-center p-0 px-1 text-body ' + props.homeActive}>
                    ...
                    <li title="Search" className='nav-item nav-tab-hidden'>
                        <Link to='/search' className={'nav-link d-flex gap-2 align-items-center p-0 px-1 text-body ' + props.searchActive}>
                    ...
                    <li title="Create" className='nav-item nav-tab-hidden'>
                        <Link to='#' className='nav-link d-flex gap-2 align-items-center p-0 px-1 text-body'>
                    ...
                    <li title="Shop" className='nav-item'>
                        <Link to='/shop' className={'nav-link d-flex gap-2 align-items-center p-0 px-1 text-body ' + props.shopActive}>
                        <i className="bi bi-bag e fs-2"></i><span className='fs-4 d-none d-lg-inline'> Shop</span>
                        </Link>
                    </li>
                    <li title="Videos" className='nav-item'>
                        <Link to='/videos' className={'nav-link d-flex gap-2 align-items-center p-0 px-1 text-body ' + props.videoActive}>
                    ...
                    <li title="Friends" className='nav-item'>
                        <Link to='/friends' className={'nav-link d-flex gap-2 align-items-center p-0 px-1 text-body ' + props.friendsActive}>
                    ...
                    <li title="Messages" className='nav-item nav-tab-hidden'>
                        <Link to='/messages' className={'nav-link d-flex gap-2 align-items-center p-0 px-1 text-body ' + props.messagesActive}>
                    ...
                    <li title="Notifications" className='nav-item'>
                        <Link to='/notifications' className={'nav-link d-flex gap-2 align-items-center p-0 px-1 text-body ' + props.notificationsActive}>
                    ...
                    <li title="Menu" className='nav-item d-block d-sm-none'>
                        <Link to='#' className='nav-link d-flex gap-2 align-items-center p-0 px-1 text-body' onClick={props.menuBtn}>
                ...
                <li title="Menu" className='position-absolute bottom-0 d-none d-sm-flex gap-2 align-items-center'>
                    <Link to='#' className='d-flex gap-2 align-items-center p-0 px-1 text-body text-decoration-none' onClick={props.menuBtn}>
                    <i className="bi bi-list fs-2"></i><span className='fs-4 d-none d-lg-inline'> Menu</span>
                    </Link>
                </li>
            </div>
